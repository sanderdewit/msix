...
function Import-MsixAccelerator {
    ...
    .DESCRIPTION
        ...
        The underlying parser is intentionally value-only (see
        ConvertFrom-MsixYamlAccelerator .NOTES): it supports flat scalars,
        inline lists, nested maps, and block lists of maps such as structured
        RemediationApproach trees, while leaving YAML type tags, anchors, and
        aliases inert.
